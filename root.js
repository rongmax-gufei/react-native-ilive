        ...
        RtcEngine.eventEmitter({
            onLoginTLS: (data) => {
                ...
                if (result) {
                    ...
                    RtcEngine.iLiveJoinChannel('learnta01', 9307909, 1);
                }
            },
            onLogoutTLS: (data) => {
                console.log(data);
